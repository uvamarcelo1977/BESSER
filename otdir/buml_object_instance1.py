...
book_0_obj = Book("Book_0").attributes(**{'pages': 13, 'release': datetime.date(1996, 7, 19), 'title': "Str"}).build()
book_1_obj = Book("Book_1").attributes(**{'pages': 14, 'release': datetime.date(1996, 7, 19), 'title': "Str"}).build()
book_2_obj = Book("Book_2").attributes(**{'pages': -12, 'release': datetime.date(1996, 7, 19), 'title': "Str"}).build()
book_3_obj = Book("Book_3").attributes(**{'pages': 14, 'release': datetime.date(1996, 7, 19), 'title': "Str"}).build()
book_4_obj = Book("Book_4").attributes(**{'pages': 13, 'release': datetime.date(1996, 7, 19), 'title': "Str"}).build()
